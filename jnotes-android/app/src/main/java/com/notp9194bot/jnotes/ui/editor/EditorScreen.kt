        ...
        topBar = {
            TopAppBar(
                ...
                actions = {
                    ...
                    IconButton(onClick = { vm.toggleReading() }) {
                        Icon(
                            Icons.Outlined.MenuBook,
                            tint = if (state.readingMode) MaterialTheme.colorScheme.primary else MaterialTheme.colorScheme.onSurface,
                    ...
                    IconButton(onClick = {
                        ...
                        Icon(
                            if (note.type == NoteType.CHECKLIST) Icons.Outlined.TextFields else Icons.Outlined.Checklist,
                    ...
                    IconButton(onClick = { showReminder = true }) {
                        Icon(
                            ...
                            tint = if (note.reminderAt > System.currentTimeMillis()) MaterialTheme.colorScheme.primary else MaterialTheme.colorScheme.onSurface,
